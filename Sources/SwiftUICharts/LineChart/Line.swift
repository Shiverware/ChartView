...
public struct Line: View {
  ...
  var gradient: ChartGradientColor = ChartGradientColor(start: ChartColors.GradientPurple, end: ChartColors.GradientNeonBlue)
  var index:Int = 0
  ...
  public var body: some View {
    ZStack {
      if(self.showFull && self.showBackground) {
        // TODO: Animation isn't working, or is too fast?
        let backgroundGradient = Gradient(colors: [gradient.start.opacity(0.3), gradient.end.opacity(0.3)])
        self.closedPath
          .fill(LinearGradient(gradient: backgroundGradient, startPoint: .leading, endPoint: .trailing))
      ...
      self.path
        ...
        .drawingGroup() // Makes the rendering animation MUCH smoother for large data sets
